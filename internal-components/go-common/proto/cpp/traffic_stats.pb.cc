...
const uint32_t TableStruct_traffic_5fstats_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_traffic_5fstats_2eproto_getter() {
  return &descriptor_table_traffic_5fstats_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_traffic_5fstats_2eproto(&descriptor_table_traffic_5fstats_2eproto);
namespace yass {
namespace fs {
...
::PROTOBUF_NAMESPACE_ID::Metadata TrafficStats::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      ...
      file_level_metadata_traffic_5fstats_2eproto[0]);
}

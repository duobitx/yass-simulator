...
#include "fs_node_online_state.pb.h"
...
const uint32_t TableStruct_fs_5fnode_5fonline_5fstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_fs_5fnode_5fonline_5fstate_2eproto_getter() {
  return &descriptor_table_fs_5fnode_5fonline_5fstate_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_fs_5fnode_5fonline_5fstate_2eproto(&descriptor_table_fs_5fnode_5fonline_5fstate_2eproto);
namespace yass {
namespace fs {
...
::PROTOBUF_NAMESPACE_ID::Metadata FsNodeId::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      ...
      file_level_metadata_fs_5fnode_5fonline_5fstate_2eproto[0]);
}

module github.com/duobitx/yass-simulator/internal-components/mqtt2prom

go 1.25.7

require (
	github.com/duobitx/yass-simulator/internal-components/go-common v0.0.0-00010101000000-000000000000

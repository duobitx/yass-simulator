...
import (
	...
	"github.com/duobitx/yass-simulator/yass-operator/internal/controller/experiment"
	"github.com/duobitx/yass-simulator/yass-operator/internal/controller/fs_node"
	yassnamespace "github.com/duobitx/yass-simulator/yass-operator/internal/controller/namespace"
	webhookv1 "github.com/duobitx/yass-simulator/yass-operator/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "60ab4360.int.esa.yass",
	...
	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupLayoutWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Layout")
			os.Exit(1)
		}
	}
	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupFsNodeWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FsNode")
			os.Exit(1)
		}
	}
